...
function App() {
  ...
  return (
    <div className={`min-h-screen bg-gray-50 ${i18n.language === 'ar' ? 'rtl' : 'ltr'}`}>
      ...
      <footer className="bg-[#f0f0f2] text-white mt-16 py-12">
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex items-center mb-6 md:mb-0">
              <img src="/LogoDeBase.png" alt="Al Salam Logo" className="h-25 w-40 mr-3" />
            </div>
            <div className="text-center md:text-right">
              <p className="mb-2 text-[#262262]">© 2025 Al Salam Islamic Center Lörrach-Maulburg</p>
              <p className="text-[#009245] text-sm">{t('footerText')}</p>
            </div>
          </div>
        </div>
      </footer>
